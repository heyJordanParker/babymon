...
module.exports = {
  parseCameraData: function(data) {
      ...
      var result = {
        has_motion: checkForMotion(json.motion_history, CAMERA_CONFIG.threshold, CAMERA_CONFIG.sample_size),
      }
      return result;
  },
  parseAudioData: function(data) {
      json = JSON.parse(data);
      var result = {
        has_motion: checkForMotion(json.motion_history, AUDIO_CONFIG.threshold, AUDIO_CONFIG.sample_size),
      }
      return result;
  }
}
